...
SECRET_KEY = "django-insecure-b-abhq_qd_jd$28ijrd0fjsy^sx6z#s8%i7+ezlw0izs*$fjz5"
...
""" CELERY SETTINGS
- when we need to run some tasks in the background, we can use celery
- example: sending emails, I/O operations etc.
"""
broker_connection_retry_on_startup = True
CELERY_BROKER_URL = "redis://localhost:6379"  # This remains unchanged
